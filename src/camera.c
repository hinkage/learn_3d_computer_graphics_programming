...
static camera_t camera = {.position = {0, 0, 0},
                          .direction = {0, 0, 1},
...
vec3_t get_camera_position(void) { return camera.position; }

vec3_t get_camera_direction(void) { return camera.direction; }

vec3_t get_camera_forward_velocity(void) { return camera.forward_velocity; }

float get_camera_yaw() { return camera.yaw; }

float get_camera_pitch() { return camera.pitch; }

void update_camera_position(vec3_t position) { camera.position = position; }

void update_camera_direction(vec3_t direction) { camera.direction = direction; }
...
vec3_t get_camera_lookat_target(void) {
    ...
    // Offset the camera position in the direction where the camera is pointing
    // at
